...
/**
 * <p>Java-Klasse für PublicTransitPropertyType complex type.
 * 
 * <p>Das folgende Schemafragment gibt den erwarteten Content an, der in dieser Klasse enthalten ist.
 * 
 * <pre>
 * &lt;complexType name="PublicTransitPropertyType"&gt;
 *   &lt;complexContent&gt;
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType"&gt;
 *       &lt;sequence minOccurs="0"&gt;
 *         &lt;element ref="{http://www.kantei.go.jp/jp/singi/tiiki/toshisaisei/itoshisaisei/iur/urt/1.4}_PublicTransit"/&gt;
 *       &lt;/sequence&gt;
...
@XmlType(name = "PublicTransitPropertyType", propOrder = {
    "_PublicTransit"
})
public class PublicTransitPropertyType {

    @XmlElementRef(name = "_PublicTransit", namespace = "http://www.kantei.go.jp/jp/singi/tiiki/toshisaisei/itoshisaisei/iur/urt/1.4", type = JAXBElement.class, required = false)
    protected JAXBElement<? extends PublicTransitType> _PublicTransit;
    ...
    /**
     * Ruft den Wert der _PublicTransit-Eigenschaft ab.
     * 
     * @return
     *     possible object is
     ...
     *     
     */
    public JAXBElement<? extends PublicTransitType> get_PublicTransit() {
        return _PublicTransit;
    }

    /**
     * Legt den Wert der _PublicTransit-Eigenschaft fest.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link LevelType }{@code >}
     ...
     *     
     */
    public void set_PublicTransit(JAXBElement<? extends PublicTransitType> value) {
        this._PublicTransit = value;
    }

    public boolean isSet_PublicTransit() {
        return (this._PublicTransit!= null);
    }
