 ...
 *         &lt;element name="populationByAgeAndSex" type="{http://www.kantei.go.jp/jp/singi/tiiki/toshisaisei/itoshisaisei/iur/urg/1.3}PopulationByAgeAndSexPropertyType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element ref="{http://www.kantei.go.jp/jp/singi/tiiki/toshisaisei/itoshisaisei/iur/urg/1.3}_GenericApplicationPropertyOfPopulation" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/extension&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "PopulationType", propOrder = {
    ...
    "_GenericApplicationPropertyOfPopulation"
})
    ...
    extends StatisticalGridType
{
    ...
    @XmlElementRef(name = "_GenericApplicationPropertyOfPopulation", namespace = "http://www.kantei.go.jp/jp/singi/tiiki/toshisaisei/itoshisaisei/iur/urg/1.3", type = JAXBElement.class, required = false)
    protected List<JAXBElement<Object>> _GenericApplicationPropertyOfPopulation;
    ...
    /**
     * Gets the value of the genericApplicationPropertyOfPopulation property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the genericApplicationPropertyOfPopulation property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    get_GenericApplicationPropertyOfPopulation().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<JAXBElement<Object>> get_GenericApplicationPropertyOfPopulation() {
        if (_GenericApplicationPropertyOfPopulation == null) {
            _GenericApplicationPropertyOfPopulation = new ArrayList<JAXBElement<Object>>();
        }
        return this._GenericApplicationPropertyOfPopulation;
    }

    public boolean isSet_GenericApplicationPropertyOfPopulation() {
        return ((this._GenericApplicationPropertyOfPopulation!= null)&&(!this._GenericApplicationPropertyOfPopulation.isEmpty()));
    }

    public void unset_GenericApplicationPropertyOfPopulation() {
        this._GenericApplicationPropertyOfPopulation = null;
    }
