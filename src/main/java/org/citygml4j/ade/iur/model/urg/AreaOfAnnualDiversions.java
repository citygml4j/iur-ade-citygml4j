...
public class AreaOfAnnualDiversions extends AbstractDataType {
    private Year year;
    ...
    public Object copyTo(Object target, CopyBuilder copyBuilder) {
        AreaOfAnnualDiversions copy = target == null ? new AreaOfAnnualDiversions() : (AreaOfAnnualDiversions) target;
        return ObjectCopier.copyTo(this, copy, copyBuilder);
    }

    @Override
    public Object copy(CopyBuilder copyBuilder) {
        return copyTo(new AreaOfAnnualDiversions(), copyBuilder);
    }
}
